...
<body>
    ...
    <div class="menu-container">
        ...
        <form action="../../../Controller/ClienteController.php" method="POST">
            <button type="submit" name="action" value="IngresarListar">Crud Cliente</button>
        </form>
        <form action="../../../Controller/TipoSuscripcionController.php" method="POST">
            <button type="submit" name="action" value="crud_suscripciones">Crud Suscripciones</button>
        </form>
